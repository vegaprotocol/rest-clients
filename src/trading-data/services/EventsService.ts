...
import type { v2ObserveEventBusResponse } from '../models/v2ObserveEventBusResponse';
...
export class EventsService {
     ...
     * @param marketId Market ID to filter for, optional field. If empty, no markets will be excluded from the stream.
     * @param partyId Party ID to filter for, optional field. If empty, no parties will be excluded from the stream.
     ...
     * @throws ApiError
     */
    public static tradingDataServiceObserveEventBus(
        ...
        result?: v2ObserveEventBusResponse;
    } | googlerpcStatus> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v2/stream/event/bus',
            query: {
                'type': type,
                'marketId': marketId,
                'partyId': partyId,
