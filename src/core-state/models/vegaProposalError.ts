 ...
 * - PROPOSAL_ERROR_INVALID_PROTOCOL_AUTOMATED_PURCHASE: Automated purchase proposal is invalid
 */
export enum vegaProposalError {
    ...
    PROPOSAL_ERROR_INVALID_PROTOCOL_AUTOMATED_PURCHASE = 'PROPOSAL_ERROR_INVALID_PROTOCOL_AUTOMATED_PURCHASE',
}
