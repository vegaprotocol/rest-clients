...
export class TransactionService {
     ...
     * @throws ApiError
     */
    public static transactionLastBlockHeight(): CancelablePromise<v1LastBlockHeightResponse | googlerpcStatus> {
     ...
     * @throws ApiError
     */
    public static transactionStatistics(): CancelablePromise<v1StatisticsResponse | googlerpcStatus> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/statistics',
        });
     ...
     * @throws ApiError
     */
    public static transactionGetSpamStatistics(
        partyId: string,
     ...
     * @throws ApiError
     */
    public static transactionGetVegaTime(): CancelablePromise<v1GetVegaTimeResponse | googlerpcStatus> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/time',
        });
     ...
     * @throws ApiError
     */
    public static transactionSubmitTransaction(
     ...
     * @throws ApiError
     */
    public static transactionCheckTransaction(
     ...
     * @throws ApiError
     */
    public static transactionSubmitRawTransaction(
     ...
     * @throws ApiError
     */
    public static transactionCheckRawTransaction(
