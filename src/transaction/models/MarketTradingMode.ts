 ...
 * - TRADING_MODE_PROTOCOL_AUTOMATED_PURCHASE_AUCTION: Scheduled auction for automated purchase
 */
export enum MarketTradingMode {
    ...
    TRADING_MODE_PROTOCOL_AUTOMATED_PURCHASE_AUCTION = 'TRADING_MODE_PROTOCOL_AUTOMATED_PURCHASE_AUCTION',
}
